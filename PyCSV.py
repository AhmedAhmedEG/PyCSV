    ...
    def on_release(self):
        ...
        if self.parent in editor.title_grid.children and self.parent.children.index(self) == 2:
            ...
            if self.background_color != [0, 0, 0, 1]:
                ...
                editor.found_list = []
                editor.find_col = editor.title_grid.children.index(self.parent)
...
class CsvEditor(Widget):
    ...
    def load(self, drag=""):
        ...
        if self.file_path != '':
            ...
            self.find_col = ((int(self.dup_col) - 1) * -1) - 1
            self.row_num = 0
            load_config()
            ...
            def load_data():
                if not exists(self.file_path + ".pycsv"):
                    ...
                    self.find_col = self.title_grid.children.index(self.title_grid.children[-1])
